...
{#if name === 'depends-on'}
  ...
  {#if state === 'closed'}
    <svg class="icon depends-on closed { className }" width="1rem" height="1rem" viewBox="0 0 12 16" version="1.1" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"></path></svg>
  {:else}
...
{#if name === 'epic'}
  <svg class="icon epic { className}" width="1rem" height="1rem" viewBox="0 0 12 16" version="1.1" aria-hidden="true" stroke="currentColor">
